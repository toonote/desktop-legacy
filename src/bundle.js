...
/***/ function(module, exports, __webpack_require__) {
	...
	let app = new _vue2.default({
		el: '#wrapper',
		store,
		computed: _extends({}, _vuex2.default.mapGetters(['layout'])),
		watch: {
			layout() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _brace = __webpack_require__(25);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {
	    ...
	    this.createWorker = function(session) {
	        var worker = new WorkerClient(["ace"], __webpack_require__(28), "JavaScriptWorker");
	...
	(function() {
	    ...
	    this.createWorker = function(session) {
	        if (this.constructor != Mode)
	            return;
	        var worker = new WorkerClient(["ace"], __webpack_require__(31), "Worker");
	        worker.attachToDocument(session.getDocument());
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		...
		mounted() {
			// console.log('[preview] mounted', this, this.$store);
			var Remarkable = __webpack_require__(38);
			var previewRenderer = new Remarkable();
			var index = 0;
